...
WSGI_APPLICATION = 'miniyoutube.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 12,
    'EXCEPTION_HANDLER': 'miniyoutube.exceptions.custom_exception_handler',
}
